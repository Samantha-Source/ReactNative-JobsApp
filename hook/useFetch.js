...
export default function useFetch(endpoint, query) {
    ...
    const options = {
        ...
        headers: {
          ...
          //TODO the api key below if for demonstration only
      ...
      const refetch = () => {
        ...
        /* THIS CODE IS ONLY TO TO PROVIDE TEST DATA AS THE API HAS EXCEEDED ITS LIMIT
          UN-COMMENT THE CODE ABOVE TO RE-ENABLE THE API ENDPOINT */
